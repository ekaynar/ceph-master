...
OPTION(directory_addr ,OPT_STR) // cache directory address 
OPTION(obj_directory_port ,OPT_STR) // cache object directory port
OPTION(block_directory_port,OPT_STR) // cache block directory port
